/*
  MOOC Fabriquer un objet connecté : TP semaine 3

 Implémentation d'un Nelson Interrupteur
...
const char* ssid     = "Livebox-A5A6";
const char* password = "35226AD1C796DE4942F4A1D293";
